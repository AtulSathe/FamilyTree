...
// ── Helper closure ─────────────────────────────────────────────────────────
def addPerson = { id, name, nameBefore, primaryTreeId ->
    g.addV('person')
     .property('personId', id)
     .property('fullName', name)
     .property('nameBefore', nameBefore ?: '')
     .property('primaryTreeId', primaryTreeId)
     .next()
}
...
// ── Sathe persons ──────────────────────────────────────────────────────────
def v_vishnupant   = addPerson('20000000-0000-0000-0000-000000000001', 'Vishnupant Sathe',  null,    satheTreeId)
def v_lakshmibai   = addPerson('20000000-0000-0000-0000-000000000002', 'Lakshmibai Sathe',  'Joshi', satheTreeId)
def v_ramchandra   = addPerson('20000000-0000-0000-0000-000000000003', 'Ramchandra Sathe',  null,    satheTreeId)
def v_sumitra      = addPerson('20000000-0000-0000-0000-000000000004', 'Sumitra Sathe',     'Kulkarni', satheTreeId)
def v_suresh       = addPerson('20000000-0000-0000-0000-000000000005', 'Suresh Sathe',      null,    satheTreeId)
def v_meena        = addPerson('20000000-0000-0000-0000-000000000006', 'Meena Sathe',       'Panse', satheTreeId) // born Panse, primaryTree=Sathe (first added)
def v_anand        = addPerson('20000000-0000-0000-0000-000000000007', 'Anand Sathe',       null,    satheTreeId)
def v_rahul        = addPerson('20000000-0000-0000-0000-000000000008', 'Rahul Sathe',       null,    satheTreeId)
def v_priya        = addPerson('20000000-0000-0000-0000-000000000009', 'Priya Sathe',       null,    satheTreeId)

// ── Panse persons ──────────────────────────────────────────────────────────
def v_dattatraya   = addPerson('20000000-0000-0000-0000-000000000010', 'Dattatraya Panse',  null,        panseTreeId)
def v_saraswati    = addPerson('20000000-0000-0000-0000-000000000011', 'Saraswati Panse',   'Deshpande', panseTreeId)
def v_govind       = addPerson('20000000-0000-0000-0000-000000000012', 'Govind Panse',      null,        panseTreeId)
def v_shanta       = addPerson('20000000-0000-0000-0000-000000000013', 'Shanta Panse',      'Gokhale',   panseTreeId)
def v_madhav       = addPerson('20000000-0000-0000-0000-000000000014', 'Madhav Panse',      null,        panseTreeId)
def v_vijaya       = addPerson('20000000-0000-0000-0000-000000000015', 'Vijaya Panse',      'Apte',      panseTreeId)
def v_arun         = addPerson('20000000-0000-0000-0000-000000000016', 'Arun Panse',        null,        panseTreeId)
def v_snehal       = addPerson('20000000-0000-0000-0000-000000000017', 'Snehal Panse',      null,        panseTreeId)
...
// Meena is daughter of Madhav (cross-tree — vertex lives in Sathe primaryTreeId)
g.addE('parent_of').from(v_madhav).to(v_meena).iterate()
g.addE('child_of').from(v_meena).to(v_madhav).iterate()
g.addE('parent_of').from(v_vijaya).to(v_meena).iterate()
g.addE('child_of').from(v_meena).to(v_vijaya).iterate()
